...
public class RNAliRTCModule extends ReactContextBaseJavaModule  implements  LifecycleEventListener{
...
//  private Map<String, AliRtcVideoTrack> mVideoCanvasMap = new HashMap<>(16);
  public RNAliRTCModule(ReactApplicationContext reactContext) {
    super(reactContext);
...
//      mEngine.setListenerHandler();
  ...
  public void startScreenRecord() {
    ...
    reactContext.startActivityForResult(permissionIntent, 1000,null);
